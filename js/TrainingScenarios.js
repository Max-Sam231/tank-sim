function getStarterGenerator15CScenario() {
  return {
    ...
    steps: [
      ...
      {
        id: "signal-lamps-cover",
        title: "Контроль сигнальных ламп — открыть крышку",
        arm: [{ action: "signal-lamps-cover", phase: "click" }],
        gateKeys: ["signalLampsCover"],
        completeWhen: (s) => Boolean(s.signalLampsCover),
      },
      {
        id: "signal-lamps-test",
        title: "Контроль сигнальных ламп — нажать кнопку",
        arm: [{ action: "signal-lamps-control", phase: "click" }],
        gateKeys: ["signalLampsControl"],
        completeWhen: (s) => Boolean(s.signalLampsCover) && Boolean(s.signalLampsControl),
      },
      {
